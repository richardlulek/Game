...
export function FacadeStructure({ volumes, kind, enabled = true }: { volumes: StructureVolume[]; kind: StructureKind; enabled?: boolean }) {
  ...
  const meshes = useMemo(() => {
    ...
    const palette = kind === "office" ? { frame: "#9aa9b2", base: "#59666e", glass: "#79939f" }
      : kind === "warehouse" ? { frame: "#6b5746", base: "#888274", glass: "#70848a" }
      : kind === "industrial" ? { frame: "#6b7477", base: "#909186", glass: "#859797" }
      : { frame: "#c5bba7", base: "#8d8577", glass: "#6e848d" };
  ...
  }, [signature, kind, coarse, enabled, overlay]);
