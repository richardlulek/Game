 ...
 * Centrum ansluts till alla grannar, Storängen nås via Industri­-
 * området och Hamnen.
 */
interface RoadSeg {
  x: number;
...
const ROADS: RoadSeg[] = [
  { x: 5, z: 122, w: 12, d: 62 }, // Centrum ↓ Hamnen
  { x: 124, z: -24, w: 66, d: 12 }, // Centrum → Industriområdet
  { x: -124, z: 10, w: 66, d: 12 }, // Centrum → Förorten
  { x: -34, z: -124, w: 12, d: 66 }, // Centrum ↑ Villakullen
  { x: 236, z: 82, w: 12, d: 92 }, // Industriområdet ↓ Storängen
  { x: 136, z: 196, w: 52, d: 12 }, // Hamnen → Storängen
];
...
function Car({
  ...
  useFrame((state) => {
    ...
    const phase = t % 2;
    const k = phase < 1 ? phase : 2 - phase; // pendla fram och tillbaka
